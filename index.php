                                    ...
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control" name="type">
												...
												<option value="flat">1 BEDROOM</option>
                                                <option value="flat">2 BEDROOM</option>
                                                <option value="flat">3BEDROOM</option>
                        ...
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- FOR MORE -->
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="1BR.png" alt="pimage">
