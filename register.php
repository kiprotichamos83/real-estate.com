...
if(isset($_REQUEST['reg']))
{
	...
	else
	{
		...
		if(!empty($name) && !empty($email) && !empty($phone) && !empty($pass) && !empty($uimage) &&!empty($city))
		{
			
			$sql="INSERT INTO user (uname,uemail,uphone,upass,utype,uimage) VALUES ('$name','$email','$phone','$pass','$utype','$uimage' '$city')";
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<form method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<input type="text"  name="city" class="form-control" placeholder="name of your city*">
									</div>
									<div class="form-group">
										<input type="password"  name="KRA pin" class="form-control" placeholder="Your KRA pin*">
									</div>
