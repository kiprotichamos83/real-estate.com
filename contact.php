                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">P.O Box 5097-30100,
Eldoret, Kenya.</span> <br>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="d-table text-white"> 0538 000 099</span>
										<span class="text-white">0538 090 200 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Address</h5>
										<span class="d-table text-white">infor@bahatiaffordablehousingeldoret.co.ke</span>
										
										</div>
                                </li>
								<li class="d-flex mb-4"> <i class="fa fa-map-marker text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">location</h5>
										<span class="d-table text-white">Daima Towers–Uganda Rd Uasin Gishu County</span>
